...
public class EasystockApplication {
    ...
    private static void addPermissionForAdmin(List<Permission> permissions){
        ...
        permissions.add(new Permission("Personne.edit"));
        permissions.add(new Permission("Personne.list"));
        permissions.add(new Permission("Personne.view"));
        permissions.add(new Permission("Personne.add"));
        permissions.add(new Permission("Personne.delete"));

...
public class AvoirVenteItemEntity   extends AuditBusinessObject     {
    ...
    public AvoirVenteItemEntity(){
        super();
    }

    public AvoirVenteItemEntity(Long id,String barCode){
        this.id = id;
        this.barCode = barCode ;
    }
    public AvoirVenteItemEntity(String barCode){
        this.barCode = barCode ;
    }
    ...
    public boolean equals(Object o) {
        ...
        AvoirVenteItemEntity avoirVenteItem = (AvoirVenteItemEntity) o;

...
public class VenteItemEntity   extends AuditBusinessObject     {
    ...
    public VenteItemEntity(){
        super();
    }

    public VenteItemEntity(Long id,String barCode){
        this.id = id;
        this.barCode = barCode ;
    }
    public VenteItemEntity(String barCode){
        this.barCode = barCode ;
    }
    ...
    public boolean equals(Object o) {
        ...
        VenteItemEntity venteItem = (VenteItemEntity) o;

...
@Component
public class AvoirVenteItemInfraConverter extends AbstractInfraConverter<AvoirVenteItemEntity, AvoirVenteItem> {
    ...
    public  AvoirVenteItemInfraConverter(){
        super(AvoirVenteItemEntity.class, AvoirVenteItem.class);
    }

    @Override
    public AvoirVenteItem toModel(AvoirVenteItemEntity entity) {
        if (entity == null) {
            return null;
        } else {
        AvoirVenteItem model = new AvoirVenteItem();
    ...
    @Override
    public AvoirVenteItemEntity toEntity(AvoirVenteItem model) {
        if (model == null) {
            return null;
        } else {
            AvoirVenteItemEntity entity = new AvoirVenteItemEntity();

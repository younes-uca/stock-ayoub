...
public class BonPourCriteria extends  BaseCriteria  {
    ...
    private String numeroBonPourLike;
    ...
    public String getNumeroBonPourLike(){
        return this.numeroBonPourLike;
    }
    public void setNumeroBonPourLike(String numeroBonPourLike){
        this.numeroBonPourLike = numeroBonPourLike;
    }

...
public class DevisCriteria extends  BaseCriteria  {
    ...
    private String numeroDevisLike;
    ...
    public String getNumeroDevisLike(){
        return this.numeroDevisLike;
    }
    public void setNumeroDevisLike(String numeroDevisLike){
        this.numeroDevisLike = numeroDevisLike;
    }

...
public class DevisItemSpecification extends  AbstractSpecification<DevisItemCriteria, DevisItemEntity>  {
    ...
    public void constructPredicates() {
        ...
        addPredicateFk("devis","numeroDevis", criteria.getDevis()==null?null:criteria.getDevis().getNumeroDevis());
    }

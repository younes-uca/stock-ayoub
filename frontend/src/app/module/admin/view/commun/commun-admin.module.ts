...
import { PersonneCreateAdminComponent } from './personne/create/personne-create-admin.component';
import { PersonneEditAdminComponent } from './personne/edit/personne-edit-admin.component';
import { PersonneViewAdminComponent } from './personne/view/personne-view-admin.component';
...
@NgModule({
  declarations: [
    ...
    PersonneCreateAdminComponent,
    PersonneListAdminComponent,
    PersonneViewAdminComponent,
    PersonneEditAdminComponent,

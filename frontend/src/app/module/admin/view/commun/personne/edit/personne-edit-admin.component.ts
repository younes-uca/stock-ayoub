...
@Component({
  selector: 'app-personne-edit-admin',
  templateUrl: './personne-edit-admin.component.html'
})
export class PersonneEditAdminComponent extends AbstractEditController<PersonneDto, PersonneCriteria, PersonneAdminService>   implements OnInit {

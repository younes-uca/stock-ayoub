...
export class EntreeProduitCreateAdminComponent extends AbstractCreateController<EntreeProduitDto, EntreeProduitCriteria, EntreeProduitAdminService>  implements OnInit {
   ...
   private _validEntreeProduitReference = true;
    ...
    constructor( private entreeProduitService: EntreeProduitAdminService , private produitService: ProduitAdminService, private entreeProduitItemService: EntreeProduitItemAdminService, private depotService: DepotAdminService, private fournisseurService: FournisseurAdminService) {

...
export class SortieProduitViewAdminComponent extends AbstractViewController<SortieProduitDto, SortieProduitCriteria, SortieProduitAdminService> implements OnInit {
    ...
    constructor(private sortieProduitService: SortieProduitAdminService, private sortieProduitItemService: SortieProduitItemAdminService, private produitService: ProduitAdminService, private depotService: DepotAdminService){

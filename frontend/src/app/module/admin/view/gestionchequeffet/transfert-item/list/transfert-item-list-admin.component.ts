...
export class TransfertItemListAdminComponent extends AbstractListController<TransfertItemDto, TransfertItemCriteria, TransfertItemAdminService>  implements OnInit {
    ...
    constructor( private transfertItemService: TransfertItemAdminService  , private produitService: ProduitAdminService, private transfertService: TransfertAdminService, private depotService: DepotAdminService) {

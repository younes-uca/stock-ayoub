...
export class AchatItemEditAdminComponent extends AbstractEditController<AchatItemDto, AchatItemCriteria, AchatItemAdminService>   implements OnInit {
    ...
    constructor( private achatItemService: AchatItemAdminService , private produitService: ProduitAdminService, private achatService: AchatAdminService, private taxeService: TaxeAdminService, private depotService: DepotAdminService) {

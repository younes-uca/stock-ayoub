...
export class AchatEditAdminComponent extends AbstractEditController<AchatDto, AchatCriteria, AchatAdminService>   implements OnInit {
    ...
    private _validAvoirsNumeroFactureAvoirAchat = true;
    private _validAvoirsDateFactureAvoirAchat = true;
    private _validAvoirsFournisseur = true;
    private _validAvoirsMontantTtc = true;



    constructor( private achatService: AchatAdminService , private produitService: ProduitAdminService, private etatAvoirAchatService: EtatAvoirAchatAdminService, private etatAchatService: EtatAchatAdminService, private entrepriseSocieteService: EntrepriseSocieteAdminService, private avoirAchatService: AvoirAchatAdminService, private taxeService: TaxeAdminService, private depotService: DepotAdminService, private achatItemService: AchatItemAdminService, private fournisseurService: FournisseurAdminService) {
        super(achatService);
    }
    ...
    public validateAvoirs(){
        ...
        this.validateAvoirsNumeroFactureAvoirAchat();
        this.validateAvoirsDateFactureAvoirAchat();
    ...
    public setValidation(value: boolean){
        ...
        this.validAvoirsNumeroFactureAvoirAchat = value;
        this.validAvoirsDateFactureAvoirAchat = value;
   ...
   public addAvoirs() {
    ...
    private validateAvoirsNumeroFactureAvoirAchat(){
        if (this.avoirsElement.numeroFactureAvoirAchat == null) {
        this.errorMessages.push('NumeroFactureAvoirAchat de la avoirAchat est  invalide');
            this.validAvoirsNumeroFactureAvoirAchat = false;
        } else {
            this.validAvoirsNumeroFactureAvoirAchat = true;
        }
    }
    private validateAvoirsDateFactureAvoirAchat(){
        if (this.avoirsElement.dateFactureAvoirAchat == null) {
        this.errorMessages.push('DateFactureAvoirAchat de la avoirAchat est  invalide');
            this.validAvoirsDateFactureAvoirAchat = false;
        } else {
            this.validAvoirsDateFactureAvoirAchat = true;
        }
    }
  ...
  set createFournisseurDialog(value: boolean) {
    ...
    get validAvoirsNumeroFactureAvoirAchat(): boolean {
        return this._validAvoirsNumeroFactureAvoirAchat;
    }
    set validAvoirsNumeroFactureAvoirAchat(value: boolean) {
        this._validAvoirsNumeroFactureAvoirAchat = value;
    }
    get validAvoirsDateFactureAvoirAchat(): boolean {
        return this._validAvoirsDateFactureAvoirAchat;
    }
    set validAvoirsDateFactureAvoirAchat(value: boolean) {
        this._validAvoirsDateFactureAvoirAchat = value;
    }

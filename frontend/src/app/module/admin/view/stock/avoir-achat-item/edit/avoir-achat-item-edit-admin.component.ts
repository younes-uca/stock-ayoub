...
export class AvoirAchatItemEditAdminComponent extends AbstractEditController<AvoirAchatItemDto, AvoirAchatItemCriteria, AvoirAchatItemAdminService>   implements OnInit {
    ...
    constructor( private avoirAchatItemService: AvoirAchatItemAdminService , private produitService: ProduitAdminService, private avoirAchatService: AvoirAchatAdminService, private depotService: DepotAdminService, private taxeService: TaxeAdminService) {

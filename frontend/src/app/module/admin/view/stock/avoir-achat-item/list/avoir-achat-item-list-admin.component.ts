...
export class AvoirAchatItemListAdminComponent extends AbstractListController<AvoirAchatItemDto, AvoirAchatItemCriteria, AvoirAchatItemAdminService>  implements OnInit {
    ...
    public initCol() {
        this.cols = [
            ...
            {field: 'avoirAchat?.numeroFactureAvoirAchat', header: 'Avoir achat'},
        ];
    }
   ...
   public prepareColumnExport(): void {
        this.exportData = this.items.map(e => {
            return {
                ...
                'Avoir achat': e.avoirAchat?.numeroFactureAvoirAchat ,
            }
        });
        ...
        //'Avoir achat': this.criteria.avoirAchat?.numeroFactureAvoirAchat ? this.criteria.avoirAchat?.numeroFactureAvoirAchat : environment.emptyForExport ,
        }];
      }
}

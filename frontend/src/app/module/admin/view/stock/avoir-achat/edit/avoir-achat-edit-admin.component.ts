...
export class AvoirAchatEditAdminComponent extends AbstractEditController<AvoirAchatDto, AvoirAchatCriteria, AvoirAchatAdminService>   implements OnInit {
    ...
    private _validAvoirAchatNumeroFactureAvoirAchat = true;
    private _validAvoirAchatDateFactureAvoirAchat = true;
    ...
    public prepareEdit() {
        this.item.dateFactureAvoirAchat = this.avoirAchatService.format(this.item.dateFactureAvoirAchat);
    }
    ...
    public setValidation(value: boolean){
        ...
        this.validAvoirAchatNumeroFactureAvoirAchat = value;
        this.validAvoirAchatDateFactureAvoirAchat = value;
   ...
   public addAvoirAchatItems() {
    ...
    public validateForm(): void{
        ...
        this.validateAvoirAchatNumeroFactureAvoirAchat();
        this.validateAvoirAchatDateFactureAvoirAchat();
    ...
    public validateAvoirAchatNumeroFactureAvoirAchat(){
        if (this.stringUtilService.isEmpty(this.item.numeroFactureAvoirAchat)) {
            this.errorMessages.push('Numero facture avoir achat non valide');
            this.validAvoirAchatNumeroFactureAvoirAchat = false;
        } else {
            this.validAvoirAchatNumeroFactureAvoirAchat = true;
        }
    }
    public validateAvoirAchatDateFactureAvoirAchat(){
        if (this.stringUtilService.isEmpty(this.item.dateFactureAvoirAchat)) {
            this.errorMessages.push('Date facture avoir achat non valide');
            this.validAvoirAchatDateFactureAvoirAchat = false;
        } else {
            this.validAvoirAchatDateFactureAvoirAchat = true;
        }
    }
  ...
  set createFournisseurDialog(value: boolean) {
    ...
    get validAvoirAchatNumeroFactureAvoirAchat(): boolean {
        return this._validAvoirAchatNumeroFactureAvoirAchat;
    }
    set validAvoirAchatNumeroFactureAvoirAchat(value: boolean) {
        this._validAvoirAchatNumeroFactureAvoirAchat = value;
    }
    get validAvoirAchatDateFactureAvoirAchat(): boolean {
        return this._validAvoirAchatDateFactureAvoirAchat;
    }
    set validAvoirAchatDateFactureAvoirAchat(value: boolean) {
        this._validAvoirAchatDateFactureAvoirAchat = value;
    }

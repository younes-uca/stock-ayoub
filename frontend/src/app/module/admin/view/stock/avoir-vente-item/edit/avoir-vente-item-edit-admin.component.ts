...
export class AvoirVenteItemEditAdminComponent extends AbstractEditController<AvoirVenteItemDto, AvoirVenteItemCriteria, AvoirVenteItemAdminService>   implements OnInit {
    ...
    constructor( private avoirVenteItemService: AvoirVenteItemAdminService , private produitService: ProduitAdminService, private avoirVenteService: AvoirVenteAdminService, private depotService: DepotAdminService, private taxeService: TaxeAdminService) {

...
export class BonPourItemListAdminComponent extends AbstractListController<BonPourItemDto, BonPourItemCriteria, BonPourItemAdminService>  implements OnInit {
    ...
    public initCol() {
        this.cols = [
            ...
            {field: 'bonPour?.numeroBonPour', header: 'Bon pour'},
        ];
    }
   ...
   public prepareColumnExport(): void {
        this.exportData = this.items.map(e => {
            return {
                ...
                'Bon pour': e.bonPour?.numeroBonPour ,
            }
        });
        ...
        //'Bon pour': this.criteria.bonPour?.numeroBonPour ? this.criteria.bonPour?.numeroBonPour : environment.emptyForExport ,
        }];
      }
}

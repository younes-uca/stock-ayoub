...
export class BonPourListAdminComponent extends AbstractListController<BonPourDto, BonPourCriteria, BonPourAdminService>  implements OnInit {
    ...
    public initCol() {
        this.cols = [
            {field: 'numeroBonPour', header: 'Numero bon pour'},
   ...
   public prepareColumnExport(): void {
        this.exportData = this.items.map(e => {
            return {
                 'Numero bon pour': e.numeroBonPour ,
        ...
        this.criteriaData = [{
            'Numero bon pour': this.criteria.numeroBonPour ? this.criteria.numeroBonPour : environment.emptyForExport ,

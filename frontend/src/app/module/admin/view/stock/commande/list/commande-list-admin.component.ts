...
export class CommandeListAdminComponent extends AbstractListController<CommandeDto, CommandeCriteria, CommandeAdminService>  implements OnInit {
    ...
    constructor( private commandeService: CommandeAdminService  , private produitService: ProduitAdminService, private clientService: ClientAdminService, private commandeItemService: CommandeItemAdminService, private taxeService: TaxeAdminService, private etatCommandeService: EtatCommandeAdminService) {

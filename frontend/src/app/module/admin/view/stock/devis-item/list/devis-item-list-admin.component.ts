...
export class DevisItemListAdminComponent extends AbstractListController<DevisItemDto, DevisItemCriteria, DevisItemAdminService>  implements OnInit {
    ...
    public initCol() {
        this.cols = [
            ...
            {field: 'devis?.numeroDevis', header: 'Devis'},
        ];
    }
   ...
   public prepareColumnExport(): void {
        ...
        //'Devis': this.criteria.devis?.numeroDevis ? this.criteria.devis?.numeroDevis : environment.emptyForExport ,
        }];
      }
}

...
export class DevisEditAdminComponent extends AbstractEditController<DevisDto, DevisCriteria, DevisAdminService>   implements OnInit {
    ...
    private _validDevisNumeroDevis = true;
    ...
    constructor( private devisService: DevisAdminService , private devisItemService: DevisItemAdminService, private produitService: ProduitAdminService, private clientService: ClientAdminService, private taxeService: TaxeAdminService) {
        super(devisService);
    }
    ...
    public setValidation(value: boolean){
        this.validDevisNumeroDevis = value;
   ...
   public addDevisItems() {
    ...
    public validateDevisNumeroDevis(){
        if (this.stringUtilService.isEmpty(this.item.numeroDevis)) {
            this.errorMessages.push('Numero devis non valide');
            this.validDevisNumeroDevis = false;
        } else {
            this.validDevisNumeroDevis = true;
        }
    }
  ...
  set createTaxeDialog(value: boolean) {
    ...
    get validDevisNumeroDevis(): boolean {
        return this._validDevisNumeroDevis;
    }
    set validDevisNumeroDevis(value: boolean) {
        this._validDevisNumeroDevis = value;
    }

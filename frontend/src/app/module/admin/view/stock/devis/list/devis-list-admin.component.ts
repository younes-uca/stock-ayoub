...
export class DevisListAdminComponent extends AbstractListController<DevisDto, DevisCriteria, DevisAdminService>  implements OnInit {
    ...
    public initCol() {
        this.cols = [
            {field: 'numeroDevis', header: 'Numero devis'},
   ...
   public prepareColumnExport(): void {
        ...
        this.criteriaData = [{
            'Numero devis': this.criteria.numeroDevis ? this.criteria.numeroDevis : environment.emptyForExport ,

...
export class InventaireEditAdminComponent extends AbstractEditController<InventaireDto, InventaireCriteria, InventaireAdminService>   implements OnInit {
    ...
    constructor( private inventaireService: InventaireAdminService , private produitService: ProduitAdminService, private inventaireItemService: InventaireItemAdminService, private entrepriseSocieteService: EntrepriseSocieteAdminService, private depotService: DepotAdminService) {

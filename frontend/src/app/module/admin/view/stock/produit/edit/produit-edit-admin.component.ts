...
export class ProduitEditAdminComponent extends AbstractEditController<ProduitDto, ProduitCriteria, ProduitAdminService>   implements OnInit {
    ...
    constructor( private produitService: ProduitAdminService , private marqueService: MarqueAdminService, private uniteMesureService: UniteMesureAdminService, private stockService: StockAdminService, private entrepriseSocieteService: EntrepriseSocieteAdminService, private categorieService: CategorieAdminService, private depotService: DepotAdminService) {

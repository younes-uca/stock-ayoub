...
export class SortieProduitItemCreateAdminComponent extends AbstractCreateController<SortieProduitItemDto, SortieProduitItemCriteria, SortieProduitItemAdminService>  implements OnInit {
   ...
   private _validSortieProduitItemQuantite = true;
    ...
    constructor( private sortieProduitItemService: SortieProduitItemAdminService , private produitService: ProduitAdminService, private sortieProduitService: SortieProduitAdminService) {

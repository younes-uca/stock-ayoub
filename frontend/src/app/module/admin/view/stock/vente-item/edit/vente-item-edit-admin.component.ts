...
export class VenteItemEditAdminComponent extends AbstractEditController<VenteItemDto, VenteItemCriteria, VenteItemAdminService>   implements OnInit {
    ...
    constructor( private venteItemService: VenteItemAdminService , private produitService: ProduitAdminService, private venteService: VenteAdminService, private depotService: DepotAdminService, private taxeService: TaxeAdminService) {
